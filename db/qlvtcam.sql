...
CREATE TABLE `giong_trong` (
  ...
  `NgayTrong` datetime DEFAULT current_timestamp(),
...
CREATE TABLE `ho_tro_ky_thuat` (
  ...
  `NgayHoTro` datetime NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `phat_hien_sau` (
  ...
  `NgayPhatHien` datetime NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `thoi_tiet` (
  ...
  `NgayDo` datetime NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `thu_hoach` (
  ...
  `NgayThuHoach` datetime NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `vu_mua` (
  ...
  `ThoiGianThuHoach` datetime DEFAULT NULL,
